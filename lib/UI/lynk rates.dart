...
import 'my_trip.dart';
class LynkRates extends StatefulWidget {
  @override
  _LynkRatesState createState() => _LynkRatesState();
}

class _LynkRatesState extends State<LynkRates> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor:Colors.black,
        title: Text("LYNK RATES",style: TextStyle(color: Colors.white),),
      ),
      drawer: Drawer(
        child: ListView(
          children: [
